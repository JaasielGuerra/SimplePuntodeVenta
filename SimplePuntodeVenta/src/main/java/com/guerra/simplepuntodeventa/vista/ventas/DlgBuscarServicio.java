 ...
 * @author Jaasiel
 */
public class DlgBuscarServicio extends javax.swing.JDialog {

    /**
     * Creates new form dlgBuscarArticulo
     */
    public DlgBuscarServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Realizar búsqueda de servicio");
        ...
        jLabel2.setText("Buscar en la descripción del servicio:");
        jPanel1.add(jLabel2);
