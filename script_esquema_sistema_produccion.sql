...
CREATE TABLE IF NOT EXISTS `db_spv`.`detalle_venta` (
  ...
  INDEX `fk_detalle_venta_usuario1_idx` (`id_usuario` ASC),
...
CREATE TABLE IF NOT EXISTS `db_spv`.`kardex` (
  ...
  `tipo` INT NOT NULL COMMENT 'ENTRADA = 1;\nSALIDA = 2;\nAJUSTE = 3;\nDEVOLUCION = 4;',
  `cantidad` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_spv`.`compra` (
  ...
  `tipo_compra` INT NOT NULL COMMENT 'COMPRA_CONTADO = 1;\nCOMPRA_CREDITO = 2;',
...
CREATE TABLE IF NOT EXISTS `db_spv`.`detalle_compra` (
  ...
  INDEX `fk_detalle_compra_usuario1_idx` (`id_usuario` ASC),
  ...
  CONSTRAINT `fk_detalle_compra_articulo1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_detalle_compra_usuario1`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `db_spv`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `db_spv`.`historial_venta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_spv`.`historial_venta` (
  `id_historial_venta` INT NOT NULL AUTO_INCREMENT,
  `fecha` DATE NOT NULL,
  `cantidad` BIGINT NOT NULL,
  `tipo` INT NOT NULL COMMENT 'VENTA_CONTADO = 1;\nVENTA_CREDITO = 2;',
  `total` DOUBLE NOT NULL,
...
-- -----------------------------------------------------
-- Table `db_spv`.`historial_compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_spv`.`historial_compra` (
  `id_historial_compra` INT NOT NULL AUTO_INCREMENT,
  `fecha` DATE NOT NULL,
  `cantidad` BIGINT NOT NULL,
  `tipo` INT NOT NULL COMMENT 'COMPRA_CONTADO = 1;\nCOMPRA_CREDITO = 2;',
  `total` DOUBLE NOT NULL,
...
DELIMITER $$
$$
CREATE TRIGGER devolucion_inventario
AFTER UPDATE 
ON detalle_venta FOR EACH ROW
BEGIN 
	-- salvar existencia anterior
...
INSERT INTO `db_spv`.`usuario` VALUES (1, 'ADMINISTRADOR SISTEMA', 'admin', 'admin', '2021/05/29', '09:48', '1', '1');
